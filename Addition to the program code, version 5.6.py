...
# Interrelation of electric charge, volume and mass of Proton,
# segment for the present time, 3D graf
...
Xnn2 = (PROTON_Present_matrix[0][0], PROTON_Present_matrix[1][0], PROTON_Present_matrix[2][0], PROTON_Present_matrix[3][0])
Ynn2 = (PROTON_Present_matrix[0][1], PROTON_Present_matrix[1][1], PROTON_Present_matrix[2][1], PROTON_Present_matrix[3][1])
Znn2 = (PROTON_Present_matrix[0][2], PROTON_Present_matrix[1][2], PROTON_Present_matrix[2][2], PROTON_Present_matrix[3][2])

ax.plot(Xnn2,Ynn2,Znn2)
...
# Interrelation of Q, M and V in neytron 2 present time, 3D graf

ax = fig.add_subplot(1, 2, 2, projection='3d')

Xnn3 = (NEUTRON2_Present_matrix[0][0], NEUTRON2_Present_matrix[1][0], NEUTRON2_Present_matrix[2][0])
Ynn3 = (NEUTRON2_Present_matrix[0][1], NEUTRON2_Present_matrix[1][1], NEUTRON2_Present_matrix[2][1])
Znn3 = (NEUTRON2_Present_matrix[0][2], NEUTRON2_Present_matrix[1][2], NEUTRON2_Present_matrix[2][2])

ax.plot(Xnn3,Ynn3,Znn3)
...
ax.text2D(0.2, 0.95, 
          ...
          "Neytron 2 segment & present time \n"
          "Graph # 31b", 
          transform=ax.transAxes, fontsize = 16)
...
# Interrelation of electric charge, volume and mass,
# segment for the PROTON Future time, 3D graf

fig = plt.figure(figsize=plt.figaspect(0.3))

ax = fig.add_subplot(1, 2, 1, projection='3d')

Xnn2 = (PROTON_Future_matrix[0][0], PROTON_Future_matrix[1][0], PROTON_Future_matrix[2][0], PROTON_Future_matrix[3][0])
Ynn2 = (PROTON_Future_matrix[0][1], PROTON_Future_matrix[1][1], PROTON_Future_matrix[2][1], PROTON_Future_matrix[3][1])
Znn2 = (PROTON_Future_matrix[0][2], PROTON_Future_matrix[1][2], PROTON_Future_matrix[2][2], PROTON_Future_matrix[3][2])
...
Xnn3 = (NEUTRON_Future_matrix[0][0], NEUTRON_Future_matrix[1][0])
Ynn3 = (NEUTRON_Future_matrix[0][1], NEUTRON_Future_matrix[1][1])
Znn3 = (NEUTRON_Future_matrix[0][2], NEUTRON_Future_matrix[1][2])
...
ax.text2D(0.2, 0.95, 
          ...
          "Neytron segment & Future time \n"
          "Graph # 43", 
          transform=ax.transAxes, fontsize = 16)

# Interrelation of electric charge, volume and mass,
# segment for the PROTON 2 Past time, 3D graf

fig = plt.figure(figsize=plt.figaspect(0.3))

ax = fig.add_subplot(1, 2, 1, projection='3d')

Xnn2 = (PROTON2_Past_matrix[0][0], PROTON2_Past_matrix[1][0], PROTON2_Past_matrix[2][0])
Ynn2 = (PROTON2_Past_matrix[0][1], PROTON2_Past_matrix[1][1], PROTON2_Past_matrix[2][1])
Znn2 = (PROTON2_Past_matrix[0][2], PROTON2_Past_matrix[1][2], PROTON2_Past_matrix[2][2])
...
ax.text2D(0.2, 0.95,         
          "Proton 2 segment & Past time \n" 
          "Graph # 44", 
          transform=ax.transAxes, fontsize = 16)

# Interrelation of Q, M and V in neytron 2, 3D graf

ax = fig.add_subplot(1, 2, 2, projection='3d')

Xnn3 = (NEUTRON2_Past_matrix[0][0], NEUTRON2_Past_matrix[1][0], NEUTRON2_Past_matrix[2][0])
Ynn3 = (NEUTRON2_Past_matrix[0][1], NEUTRON2_Past_matrix[1][1], NEUTRON2_Past_matrix[2][1])
Znn3 = (NEUTRON2_Past_matrix[0][2], NEUTRON2_Past_matrix[1][2], NEUTRON2_Past_matrix[2][2])
...
ax.text2D(0.2, 0.95, 
          ...
          "Neytron 2 segment & Past time \n"
          "Graph # 45",           
          transform=ax.transAxes, fontsize = 16)

# Schematic representation for a segment of a neutron and a proton in the past, 
# a neutron 2 and a proton 2 in the future.
if (NEUTRON_Past_matrix[0][0] == NEUTRON_Past_matrix[1][0] and
 NEUTRON_Past_matrix[0][1] == NEUTRON_Past_matrix[1][1] and 
 NEUTRON_Past_matrix[0][2] == NEUTRON_Past_matrix[1][2] and 
 NEUTRON2_Future_matrix[0][0] == NEUTRON2_Future_matrix[1][0] == NEUTRON2_Future_matrix[2][0] and
 NEUTRON2_Future_matrix[0][1] == NEUTRON2_Future_matrix[1][1] == NEUTRON2_Future_matrix[2][1] and 
 NEUTRON2_Future_matrix[0][2] == NEUTRON2_Future_matrix[1][2] == NEUTRON2_Future_matrix[2][2] and 
 len(PROTON2_Future_matrix) == len(PROTON_Past_matrix)) == True:
    fig = plt.figure()
    ...
    (ax.plot(a[0] * np.sin(u) + b[0] * np.cos(u), b[1] * np.cos(u), a[2] * np.sin(u) + 
             b[2] * np.cos(u),color='k', linestyle = 'dashed'))
    ...
    ax.text2D(0.2, 0.95, 
          ...
          "Schematic representation for a segment \n"
          "of a neutron and a proton in the past, \n"
          "a neutron 2 and a proton 2 in the future. \n"
          "Graph # 46", 
          transform=ax.transAxes, fontsize = 16)
    plt.show()
