...
# The ratio of Planck's constant to the speed of light in a vacuum, <br>
...
<p> For example, the points of small extrema on the graph n demonstrate the possibility of creating a measuring device for studying the structure of matter, and the point of maximum extremum will allow the user to create a neutron cutter. Used 512 dots. </p>
<p> The graph n3 allows the user to better understand the effect of gravity, frequencies at different speeds on neutron shells at different speeds. Used 64000 dots. </p>
<h2> Credits: </h2>
